  ...
  describe('get_run_at_cursor', function()
    it('should return run index when cursor is on a run line', function()
      ...
      vim.api.nvim_buf_set_lines(bufnr, 0, -1, false, {
        'l expand/view logs, h collapse, r refresh, R rerun, d dispatch, w watch, q close',
        '',
      ...
      local run_idx = cursor_tracker.get_run_at_cursor(runs)
      assert.equals(1, run_idx)

      -- Move cursor to second run (line 4)
      vim.api.nvim_win_set_cursor(0, { 4, 0 })
      run_idx = cursor_tracker.get_run_at_cursor(runs)
